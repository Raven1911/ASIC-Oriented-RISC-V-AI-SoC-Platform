...
# ############################################ DIP SWITCHES ##########################################
# ####################################################################################################
# set_property -dict { PACKAGE_PIN AV30 IOSTANDARD LVCMOS18 } [get_ports { resetn }]; # DIP switch 0
# # set_property -dict { PACKAGE_PIN AY33 IOSTANDARD LVCMOS18 } [get_ports { pb[0] }]; # DIP switch 1
# # set_property -dict { PACKAGE_PIN BA31 IOSTANDARD LVCMOS18 } [get_ports { pb[1] }]; # DIP switch 2
# # set_property -dict { PACKAGE_PIN BA32 IOSTANDARD LVCMOS18 } [get_ports { pb[2] }]; # DIP switch 3
# # set_property -dict { PACKAGE_PIN AW30 IOSTANDARD LVCMOS18 } [get_ports { pb[3] }]; # DIP switch 4
# # set_property -dict { PACKAGE_PIN AY30 IOSTANDARD LVCMOS18 } [get_ports { pb[4] }]; # DIP switch 5
# # set_property -dict { PACKAGE_PIN BA30 IOSTANDARD LVCMOS18 } [get_ports { pb[5] }]; # DIP switch 6
# # set_property -dict { PACKAGE_PIN BB31 IOSTANDARD LVCMOS18 } [get_ports { sw_enb_i }]; # DIP switch 7
...
# set_property -dict { PACKAGE_PIN AM39 IOSTANDARD LVCMOS18 } [get_ports { trap0 }]; # LED 0
# set_property -dict { PACKAGE_PIN AN39 IOSTANDARD LVCMOS18 } [get_ports { trap1 }]; # LED 1
# # set_property -dict { PACKAGE_PIN AR37 IOSTANDARD LVCMOS18 } [get_ports { adv7511_clk }]; # LED 2
# # set_property -dict { PACKAGE_PIN AT37 IOSTANDARD LVCMOS18 } [get_ports { adv7511_de }]; # LED 3
# # set_property -dict { PACKAGE_PIN AP41 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_5_LS }]; # LED 5
# # set_property -dict { PACKAGE_PIN AP42 IOSTANDARD LVCMOS18 } [get_ports { READY }]; # LED 6
# # set_property -dict { PACKAGE_PIN AP40 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_S }];     # Push Switch South
# # set_property -dict { PACKAGE_PIN AR40 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_N }];     # Push Switch North
...
# ##############################################################
# # # --- LA Bank (00 to 16) ---
# set_property -dict { PACKAGE_PIN AD40 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[0] }];    # AD40 FMC2_HPC_LA00_CC_P
# set_property -dict { PACKAGE_PIN AD41 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[1] }];    # AD41 FMC2_HPC_LA00_CC_N
# set_property -dict { PACKAGE_PIN AF41 IOSTANDARD LVCMOS18 } [get_ports { uart0_rx }];    # AF41 FMC2_HPC_LA01_CC_P
# set_property -dict { PACKAGE_PIN AG41 IOSTANDARD LVCMOS18 } [get_ports { uart0_tx }];    # AG41 FMC2_HPC_LA01_CC_N
# set_property -dict { PACKAGE_PIN AK39 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[4] }];       # AK39 FMC2_HPC_LA02_P
# set_property -dict { PACKAGE_PIN AL39 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[5] }];       # AL39 FMC2_HPC_LA02_N
# set_property -dict { PACKAGE_PIN AJ42 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[2] }];       # AJ42 FMC2_HPC_LA03_P
# set_property -dict { PACKAGE_PIN AK42 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[3] }];       # AK42 FMC2_HPC_LA03_N
# set_property -dict { PACKAGE_PIN AL41 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[6] }];       # AL41 FMC2_HPC_LA04_P
# set_property -dict { PACKAGE_PIN AL42 IOSTANDARD LVCMOS18 } [get_ports { gpio_io[7] }];       # AL42 FMC2_HPC_LA04_N
# set_property -dict { PACKAGE_PIN AF42 IOSTANDARD LVCMOS18 } [get_ports { i2c0_scl }];       # AF42 FMC2_HPC_LA05_P
# set_property -dict { PACKAGE_PIN AG42 IOSTANDARD LVCMOS18 } [get_ports { i2c0_sda }];       # AG42 FMC2_HPC_LA05_N
# set_property -dict { PACKAGE_PIN AD38 IOSTANDARD LVCMOS18 } [get_ports { spi0_clk }];       # AD38 FMC2_HPC_LA06_P
# set_property -dict { PACKAGE_PIN AE38 IOSTANDARD LVCMOS18 } [get_ports { spi0_mosi }];       # AE38 FMC2_HPC_LA06_N
# # set_property -dict { PACKAGE_PIN AC40 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA07_P }];       # AC40 FMC2_HPC_LA07_P
# # set_property -dict { PACKAGE_PIN AC41 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA07_N }];       # AC41 FMC2_HPC_LA07_N
# # set_property -dict { PACKAGE_PIN AD42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA08_P }];       # AD42 FMC2_HPC_LA08_P
# # set_property -dict { PACKAGE_PIN AE42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA08_N }];       # AE42 FMC2_HPC_LA08_N
# # set_property -dict { PACKAGE_PIN AJ38 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA09_P }];       # AJ38 FMC2_HPC_LA09_P
# # set_property -dict { PACKAGE_PIN AK38 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA09_N }];       # AK38 FMC2_HPC_LA09_N
# set_property -dict { PACKAGE_PIN AB41 IOSTANDARD LVCMOS18 } [get_ports { spi0_miso }];       # AB41 FMC2_HPC_LA10_P
# set_property -dict { PACKAGE_PIN AB42 IOSTANDARD LVCMOS18 } [get_ports { spi0_ss_n[0] }];       # AB42 FMC2_HPC_LA10_N
...
# # set_property -dict { PACKAGE_PIN W40  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA13_P }];       # W40  FMC2_HPC_LA13_P
# # set_property -dict { PACKAGE_PIN Y40  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA13_N }];       # Y40  FMC2_HPC_LA13_N
# set_property -dict { PACKAGE_PIN AB38 IOSTANDARD LVCMOS18 } [get_ports { spi0_ss_n[1] }];       # AB38 FMC2_HPC_LA14_P
# # set_property -dict { PACKAGE_PIN AB39 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA14_N }];       # AB39 FMC2_HPC_LA14_N
# # set_property -dict { PACKAGE_PIN AC38 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA15_P }];       # AC38 FMC2_HPC_LA15_P
# # set_property -dict { PACKAGE_PIN AC39 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA15_N }];       # AC39 FMC2_HPC_LA15_N
...
# # # --- LA Bank (17 to 31) ---
# # set_property -dict { PACKAGE_PIN U37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA17_CC_P }];    # U37  FMC2_HPC_LA17_CC_P
# # set_property -dict { PACKAGE_PIN U38  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA17_CC_N }];    # U38  FMC2_HPC_LA17_CC_N
...
# # set_property -dict { PACKAGE_PIN U32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA19_P }];       # U32  FMC2_HPC_LA19_P
# # set_property -dict { PACKAGE_PIN U33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA19_N }];       # U33  FMC2_HPC_LA19_N
# # set_property -dict { PACKAGE_PIN V33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA20_P }];       # V33  FMC2_HPC_LA20_P
# # set_property -dict { PACKAGE_PIN V34  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA20_N }];       # V34  FMC2_HPC_LA20_N
# # set_property -dict { PACKAGE_PIN P35  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA21_P }];       # P35  FMC2_HPC_LA21_P
# # set_property -dict { PACKAGE_PIN P36  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA21_N }];       # P36  FMC2_HPC_LA21_N
# # set_property -dict { PACKAGE_PIN W32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA22_P }];       # W32  FMC2_HPC_LA22_P
# # set_property -dict { PACKAGE_PIN W33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA22_N }];       # W33  FMC2_HPC_LA22_N
# # set_property -dict { PACKAGE_PIN R38  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA23_P }];       # R38  FMC2_HPC_LA23_P
# # set_property -dict { PACKAGE_PIN R39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA23_N }];       # R39  FMC2_HPC_LA23_N
...
# # set_property -dict { PACKAGE_PIN N33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA26_P }];       # N33  FMC2_HPC_LA26_P
# # set_property -dict { PACKAGE_PIN N34  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA26_N }];       # N34  FMC2_HPC_LA26_N
# # set_property -dict { PACKAGE_PIN P32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA27_P }];       # P32  FMC2_HPC_LA27_P
# # set_property -dict { PACKAGE_PIN P33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA27_N }];       # P33  FMC2_HPC_LA27_N
# # set_property -dict { PACKAGE_PIN V35  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA28_P }];       # V35  FMC2_HPC_LA28_P
# # set_property -dict { PACKAGE_PIN V36  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA28_N }];       # V36  FMC2_HPC_LA28_N
# # set_property -dict { PACKAGE_PIN W36  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA29_P }];       # W36  FMC2_HPC_LA29_P
# # set_property -dict { PACKAGE_PIN W37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA29_N }];       # W37  FMC2_HPC_LA29_N
...
# # set_property -dict { PACKAGE_PIN V39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA31_P }];       # V39  FMC2_HPC_LA31_P
# # set_property -dict { PACKAGE_PIN V40  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA31_N }];       # V40  FMC2_HPC_LA31_N
# # set_property -dict { PACKAGE_PIN P37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA32_P }];       # P37  FMC2_HPC_LA32_P
# # set_property -dict { PACKAGE_PIN P38  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA32_N }];       # P38  FMC2_HPC_LA32_N
...
# # set_property -dict { PACKAGE_PIN U39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK1_M2C_P }];   # U39  FMC2_HPC_CLK1_M2C_P
# # set_property -dict { PACKAGE_PIN T39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK1_M2C_N }];   # T39  FMC2_HPC_CLK1_M2C_N

# # # --- HA Bank ---
# # set_property -dict { PACKAGE_PIN AB33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA00_CC_P }];    # AB33 FMC2_HPC_HA00_CC_P
# # set_property -dict { PACKAGE_PIN AC33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA00_CC_N }];    # AC33 FMC2_HPC_HA00_CC_N
# # set_property -dict { PACKAGE_PIN AD32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA01_CC_P }];    # AD32 FMC2_HPC_HA01_CC_P
# # set_property -dict { PACKAGE_PIN AD33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA01_CC_N }];    # AD33 FMC2_HPC_HA01_CC_N
# # set_property -dict { PACKAGE_PIN AC30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA02_P }];       # AC30 FMC2_HPC_HA02_P
# # set_property -dict { PACKAGE_PIN AD30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA02_N }];       # AD30 FMC2_HPC_HA02_N
# # set_property -dict { PACKAGE_PIN AA29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA03_P }];       # AA29 FMC2_HPC_HA03_P
# # set_property -dict { PACKAGE_PIN AA30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA03_N }];       # AA30 FMC2_HPC_HA03_N
# # set_property -dict { PACKAGE_PIN AB29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA04_P }];       # AB29 FMC2_HPC_HA04_P
# # set_property -dict { PACKAGE_PIN AC29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA04_N }];       # AC29 FMC2_HPC_HA04_N
# # set_property -dict { PACKAGE_PIN Y32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA05_P }];       # Y32  FMC2_HPC_HA05_P
# # set_property -dict { PACKAGE_PIN Y33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA05_N }];       # Y33  FMC2_HPC_HA05_N
# # set_property -dict { PACKAGE_PIN AB31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA06_P }];       # AB31 FMC2_HPC_HA06_P
# # set_property -dict { PACKAGE_PIN AB32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA06_N }];       # AB32 FMC2_HPC_HA06_N
# # set_property -dict { PACKAGE_PIN AC31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA07_P }];       # AC31 FMC2_HPC_HA07_P
# # set_property -dict { PACKAGE_PIN AD31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA07_N }];       # AD31 FMC2_HPC_HA07_N
# # set_property -dict { PACKAGE_PIN AA31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA08_P }];       # AA31 FMC2_HPC_HA08_P
# # set_property -dict { PACKAGE_PIN AA32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA08_N }];       # AA32 FMC2_HPC_HA08_N
# # set_property -dict { PACKAGE_PIN AE29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA09_P }];       # AE29 FMC2_HPC_HA09_P
# # set_property -dict { PACKAGE_PIN AE30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA09_N }];       # AE30 FMC2_HPC_HA09_N
# # set_property -dict { PACKAGE_PIN AF31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA10_P }];       # AF31 FMC2_HPC_HA10_P
# # set_property -dict { PACKAGE_PIN AF32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA10_N }];       # AF32 FMC2_HPC_HA10_N
# # set_property -dict { PACKAGE_PIN AE34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA11_P }];       # AE34 FMC2_HPC_HA11_P
# # set_property -dict { PACKAGE_PIN AE35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA11_N }];       # AE35 FMC2_HPC_HA11_N
# # set_property -dict { PACKAGE_PIN AF34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA12_P }];       # AF34 FMC2_HPC_HA12_P
# # set_property -dict { PACKAGE_PIN AG34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA12_N }];       # AG34 FMC2_HPC_HA12_N
# # set_property -dict { PACKAGE_PIN AE32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA13_P }];       # AE32 FMC2_HPC_HA13_P
# # set_property -dict { PACKAGE_PIN AE33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA13_N }];       # AE33 FMC2_HPC_HA13_N
# # set_property -dict { PACKAGE_PIN AF35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA14_P }];       # AF35 FMC2_HPC_HA14_P
# # set_property -dict { PACKAGE_PIN AF36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA14_N }];       # AF36 FMC2_HPC_HA14_N
# # set_property -dict { PACKAGE_PIN AE37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_P }];       # AE37 FMC2_HPC_HA15_P
# # set_property -dict { PACKAGE_PIN AF37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_N }];       # AF37 FMC2_HPC_HA15_N
# # set_property -dict { PACKAGE_PIN AG36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA16_P }];       # AG36 FMC2_HPC_HA16_P
# # set_property -dict { PACKAGE_PIN AH36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA16_N }];       # AH36 FMC2_HPC_HA16_N
# # set_property -dict { PACKAGE_PIN AC34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA17_CC_P }];    # AC34 FMC2_HPC_HA17_CC_P
# # set_property -dict { PACKAGE_PIN AD35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA17_CC_N }];    # AD35 FMC2_HPC_HA17_CC_N
# # set_property -dict { PACKAGE_PIN AB36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA18_P }];       # AB36 FMC2_HPC_HA18_P
# # set_property -dict { PACKAGE_PIN AB37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA18_N }];       # AB37 FMC2_HPC_HA18_N
# # set_property -dict { PACKAGE_PIN AC35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA19_P }];       # AC35 FMC2_HPC_HA19_P
# # set_property -dict { PACKAGE_PIN AC36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA19_N }];       # AC36 FMC2_HPC_HA19_N
# # set_property -dict { PACKAGE_PIN AD36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA20_P }];       # AD36 FMC2_HPC_HA20_P
# # set_property -dict { PACKAGE_PIN AD37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA20_N }];       # AD37 FMC2_HPC_HA20_N
# # set_property -dict { PACKAGE_PIN AA34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA21_P }];       # AA34 FMC2_HPC_HA21_P
# # set_property -dict { PACKAGE_PIN AA35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA21_N }];       # AA35 FMC2_HPC_HA21_N
# # set_property -dict { PACKAGE_PIN Y35  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA22_P }];       # Y35  FMC2_HPC_HA22_P
# # set_property -dict { PACKAGE_PIN AA36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA22_N }];       # AA36 FMC2_HPC_HA22_N
# # set_property -dict { PACKAGE_PIN Y37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_P }];       # Y37  FMC2_HPC_HA23_P
# # set_property -dict { PACKAGE_PIN AA37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_N }];       # AA37 FMC2_HPC_HA23_N
...
# ##############################################################
# # # --- LA Bank (00 to 16) ---
# # set_property -dict { PACKAGE_PIN K39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA00_CC_P }];    # K39  FMC1_HPC_LA00_CC_P
# # set_property -dict { PACKAGE_PIN K40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA00_CC_N }];    # K40  FMC1_HPC_LA00_CC_N
# # set_property -dict { PACKAGE_PIN J40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_P }];    # J40  FMC1_HPC_LA01_CC_P
# # set_property -dict { PACKAGE_PIN J41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_N }];    # J41  FMC1_HPC_LA01_CC_N
# # set_property -dict { PACKAGE_PIN P41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA02_P }];       # P41  FMC1_HPC_LA02_P
# # set_property -dict { PACKAGE_PIN N41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA02_N }];       # N41  FMC1_HPC_LA02_N
# # set_property -dict { PACKAGE_PIN M42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA03_P }];       # M42  FMC1_HPC_LA03_P
# # set_property -dict { PACKAGE_PIN L42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA03_N }];       # L42  FMC1_HPC_LA03_N
# # set_property -dict { PACKAGE_PIN H40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA04_P }];       # H40  FMC1_HPC_LA04_P
# # set_property -dict { PACKAGE_PIN H41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA04_N }];       # H41  FMC1_HPC_LA04_N
# # set_property -dict { PACKAGE_PIN M41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA05_P }];       # M41  FMC1_HPC_LA05_P
# # set_property -dict { PACKAGE_PIN L41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA05_N }];       # L41  FMC1_HPC_LA05_N
# # set_property -dict { PACKAGE_PIN K42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA06_P }];       # K42  FMC1_HPC_LA06_P
# # set_property -dict { PACKAGE_PIN J42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA06_N }];       # J42  FMC1_HPC_LA06_N
# # set_property -dict { PACKAGE_PIN G41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA07_P }];       # G41  FMC1_HPC_LA07_P
# # set_property -dict { PACKAGE_PIN G42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA07_N }];       # G42  FMC1_HPC_LA07_N
# # set_property -dict { PACKAGE_PIN M37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA08_P }];       # M37  FMC1_HPC_LA08_P
# # set_property -dict { PACKAGE_PIN M38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA08_N }];       # M38  FMC1_HPC_LA08_N
# # set_property -dict { PACKAGE_PIN R42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_P }];       # R42  FMC1_HPC_LA09_P
# # set_property -dict { PACKAGE_PIN P42 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_N }];       # P42  FMC1_HPC_LA09_N
# # set_property -dict { PACKAGE_PIN N38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA10_P }];       # N38  FMC1_HPC_LA10_P
# # set_property -dict { PACKAGE_PIN M39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA10_N }];       # M39  FMC1_HPC_LA10_N
# # set_property -dict { PACKAGE_PIN F40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA11_P }];       # F40  FMC1_HPC_LA11_P
# # set_property -dict { PACKAGE_PIN F41 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA11_N }];       # F41  FMC1_HPC_LA11_N
# # set_property -dict { PACKAGE_PIN R40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA12_P }];       # R40  FMC1_HPC_LA12_P
# # set_property -dict { PACKAGE_PIN P40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA12_N }];       # P40  FMC1_HPC_LA12_N
# # set_property -dict { PACKAGE_PIN H39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA13_P }];       # H39  FMC1_HPC_LA13_P
# # set_property -dict { PACKAGE_PIN G39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA13_N }];       # G39  FMC1_HPC_LA13_N
# # set_property -dict { PACKAGE_PIN N39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_P }];       # N39  FMC1_HPC_LA14_P
# # set_property -dict { PACKAGE_PIN N40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_N }];       # N40  FMC1_HPC_LA14_N
# set_property -dict { PACKAGE_PIN M36 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[7] }];       # M36  FMC1_HPC_LA15_P
# set_property -dict { PACKAGE_PIN L37 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[6] }];       # L37  FMC1_HPC_LA15_N
# # set_property -dict { PACKAGE_PIN K37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_P }];       # K37  FMC1_HPC_LA16_P
# # set_property -dict { PACKAGE_PIN K38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_N }];       # K38  FMC1_HPC_LA16_N
# # set_property -dict { PACKAGE_PIN L39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_P }];   # L39  FMC1_HPC_CLK0_M2C_P
# # set_property -dict { PACKAGE_PIN L40 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_N }];   # L40  FMC1_HPC_CLK0_M2C_N

# # # --- LA Bank (17 to 33) ---
# # set_property -dict { PACKAGE_PIN L31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA17_CC_P }];    # L31  FMC1_HPC_LA17_CC_P
# # set_property -dict { PACKAGE_PIN K32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA17_CC_N }];    # K32  FMC1_HPC_LA17_CC_N
# # set_property -dict { PACKAGE_PIN M32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA18_CC_P }];    # M32  FMC1_HPC_LA18_CC_P
# # set_property -dict { PACKAGE_PIN L32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA18_CC_N }];    # L32  FMC1_HPC_LA18_CC_N
# set_property -dict { PACKAGE_PIN W30 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[1] }];       # W30  FMC1_HPC_LA19_P
# set_property -dict { PACKAGE_PIN W31 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[5] }];       # W31  FMC1_HPC_LA19_N
# # set_property -dict { PACKAGE_PIN Y29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA20_P }];       # Y29  FMC1_HPC_LA20_P
# # set_property -dict { PACKAGE_PIN Y30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA20_N }];       # Y30  FMC1_HPC_LA20_N
# set_property -dict { PACKAGE_PIN N28 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[0] }];       # N28  FMC1_HPC_LA21_P
# set_property -dict { PACKAGE_PIN N29 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[3] }];       # N29  FMC1_HPC_LA21_N
# # set_property -dict { PACKAGE_PIN R28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA22_P }];       # R28  FMC1_HPC_LA22_P
# # set_property -dict { PACKAGE_PIN P28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA22_N }];       # P28  FMC1_HPC_LA22_N
# # set_property -dict { PACKAGE_PIN P30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA23_P }];       # P30  FMC1_HPC_LA23_P
# # set_property -dict { PACKAGE_PIN N31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA23_N }];       # N31  FMC1_HPC_LA23_N
# set_property -dict { PACKAGE_PIN R30 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[4] }];       # R30  FMC1_HPC_LA24_P
# set_property -dict { PACKAGE_PIN P31 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_dq_io[2] }];       # P31  FMC1_HPC_LA24_N
# # set_property -dict { PACKAGE_PIN K29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA25_P }];       # K29  FMC1_HPC_LA25_P
# # set_property -dict { PACKAGE_PIN K30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA25_N }];       # K30  FMC1_HPC_LA25_N
# # set_property -dict { PACKAGE_PIN J30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA26_P }];       # J30  FMC1_HPC_LA26_P
# # set_property -dict { PACKAGE_PIN H30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA26_N }];       # H30  FMC1_HPC_LA26_N
# # set_property -dict { PACKAGE_PIN J31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA27_P }];       # J31  FMC1_HPC_LA27_P
# # set_property -dict { PACKAGE_PIN H31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA27_N }];       # H31  FMC1_HPC_LA27_N
# set_property -dict { PACKAGE_PIN L29 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_rwds_io }];       # L29  FMC1_HPC_LA28_P
# set_property -dict { PACKAGE_PIN L30 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_cs_n }];       # L30  FMC1_HPC_LA28_N
# # set_property -dict { PACKAGE_PIN T29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA29_P }];       # T29  FMC1_HPC_LA29_P
# # set_property -dict { PACKAGE_PIN T30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA29_N }];       # T30  FMC1_HPC_LA29_N
# set_property -dict { PACKAGE_PIN V30 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_hclk_p }];       # V30  FMC1_HPC_LA30_P
# # set_property -dict { PACKAGE_PIN V31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA30_N }];       # V31  FMC1_HPC_LA30_N
# # set_property -dict { PACKAGE_PIN M28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA31_P }];       # M28  FMC1_HPC_LA31_P
# # set_property -dict { PACKAGE_PIN M29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA31_N }];       # M29  FMC1_HPC_LA31_N
# set_property -dict { PACKAGE_PIN V29 IOSTANDARD LVCMOS18 } [get_ports { hyperram0_resetn }];       # V29  FMC1_HPC_LA32_P
# # set_property -dict { PACKAGE_PIN U29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA32_N }];       # U29  FMC1_HPC_LA32_N
# # set_property -dict { PACKAGE_PIN U31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA33_P }];       # U31  FMC1_HPC_LA33_P
# # set_property -dict { PACKAGE_PIN T31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA33_N }];       # T31  FMC1_HPC_LA33_N
# # set_property -dict { PACKAGE_PIN N30 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK1_M2C_P }];   # N30  FMC1_HPC_CLK1_M2C_P
# # set_property -dict { PACKAGE_PIN M31 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK1_M2C_N }];   # M31  FMC1_HPC_CLK1_M2C_N

# # # --- HA Bank ---
# # set_property -dict { PACKAGE_PIN E34 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA00_CC_P }];    # E34  FMC1_HPC_HA00_CC_P
# # set_property -dict { PACKAGE_PIN E35 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA00_CC_N }];    # E35  FMC1_HPC_HA00_CC_N
# # set_property -dict { PACKAGE_PIN D35 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA01_CC_P }];    # D35  FMC1_HPC_HA01_CC_P
# # set_property -dict { PACKAGE_PIN D36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA01_CC_N }];    # D36  FMC1_HPC_HA01_CC_N
# # set_property -dict { PACKAGE_PIN E33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA02_P }];       # E33  FMC1_HPC_HA02_P
# # set_property -dict { PACKAGE_PIN D33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA02_N }];       # D33  FMC1_HPC_HA02_N
# # set_property -dict { PACKAGE_PIN H33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA03_P }];       # H33  FMC1_HPC_HA03_P
# # set_property -dict { PACKAGE_PIN G33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA03_N }];       # G33  FMC1_HPC_HA03_N
# # set_property -dict { PACKAGE_PIN F34 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA04_P }];       # F34  FMC1_HPC_HA04_P
# # set_property -dict { PACKAGE_PIN F35 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA04_N }];       # F35  FMC1_HPC_HA04_N
# # set_property -dict { PACKAGE_PIN G32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA05_P }];       # G32  FMC1_HPC_HA05_P
# # set_property -dict { PACKAGE_PIN F32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA05_N }];       # F32  FMC1_HPC_HA05_N
# # set_property -dict { PACKAGE_PIN G36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA06_P }];       # G36  FMC1_HPC_HA06_P
# # set_property -dict { PACKAGE_PIN G37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA06_N }];       # G37  FMC1_HPC_HA06_N
# # set_property -dict { PACKAGE_PIN C38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA07_P }];       # C38  FMC1_HPC_HA07_P
# # set_property -dict { PACKAGE_PIN C39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA07_N }];       # C39  FMC1_HPC_HA07_N
# # set_property -dict { PACKAGE_PIN J36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA08_P }];       # J36  FMC1_HPC_HA08_P
# # set_property -dict { PACKAGE_PIN H36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA08_N }];       # H36  FMC1_HPC_HA08_N
# # set_property -dict { PACKAGE_PIN E32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA09_P }];       # E32  FMC1_HPC_HA09_P
# # set_property -dict { PACKAGE_PIN D32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA09_N }];       # D32  FMC1_HPC_HA09_N
# # set_property -dict { PACKAGE_PIN H38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA10_P }];       # H38  FMC1_HPC_HA10_P
# # set_property -dict { PACKAGE_PIN G38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA10_N }];       # G38  FMC1_HPC_HA10_N
# # set_property -dict { PACKAGE_PIN J37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA11_P }];       # J37  FMC1_HPC_HA11_P
# # set_property -dict { PACKAGE_PIN J38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA11_N }];       # J38  FMC1_HPC_HA11_N
# # set_property -dict { PACKAGE_PIN B37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA12_P }];       # B37  FMC1_HPC_HA12_P
# # set_property -dict { PACKAGE_PIN B38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA12_N }];       # B38  FMC1_HPC_HA12_N
# # set_property -dict { PACKAGE_PIN B36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA13_P }];       # B36  FMC1_HPC_HA13_P
# # set_property -dict { PACKAGE_PIN A37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA13_N }];       # A37  FMC1_HPC_HA13_N
# # set_property -dict { PACKAGE_PIN E37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA14_P }];       # E37  FMC1_HPC_HA14_P
# # set_property -dict { PACKAGE_PIN E38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA14_N }];       # E38  FMC1_HPC_HA14_N
# # set_property -dict { PACKAGE_PIN C33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA15_P }];       # C33  FMC1_HPC_HA15_P
# # set_property -dict { PACKAGE_PIN C34 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA15_N }];       # C34  FMC1_HPC_HA15_N
# # set_property -dict { PACKAGE_PIN B39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA16_P }];       # B39  FMC1_HPC_HA16_P
# # set_property -dict { PACKAGE_PIN A39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA16_N }];       # A39  FMC1_HPC_HA16_N
# # set_property -dict { PACKAGE_PIN C35 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA17_CC_P }];    # C35  FMC1_HPC_HA17_CC_P
# # set_property -dict { PACKAGE_PIN C36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA17_CC_N }];    # C36  FMC1_HPC_HA17_CC_N
# # set_property -dict { PACKAGE_PIN F39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA18_P }];       # F39  FMC1_HPC_HA18_P
# # set_property -dict { PACKAGE_PIN E39 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA18_N }];       # E39  FMC1_HPC_HA18_N
# # set_property -dict { PACKAGE_PIN B32 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA19_P }];       # B32  FMC1_HPC_HA19_P
# # set_property -dict { PACKAGE_PIN B33 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA19_N }];       # B33  FMC1_HPC_HA19_N
# # set_property -dict { PACKAGE_PIN B34 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA20_P }];       # B34  FMC1_HPC_HA20_P
# # set_property -dict { PACKAGE_PIN A34 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA20_N }];       # A34  FMC1_HPC_HA20_N
# # set_property -dict { PACKAGE_PIN D37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA21_P }];       # D37  FMC1_HPC_HA21_P
# # set_property -dict { PACKAGE_PIN D38 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA21_N }];       # D38  FMC1_HPC_HA21_N
# # set_property -dict { PACKAGE_PIN F36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA22_P }];       # F36  FMC1_HPC_HA22_P
# # set_property -dict { PACKAGE_PIN F37 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA22_N }];       # F37  FMC1_HPC_HA22_N
# # set_property -dict { PACKAGE_PIN A35 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA23_P }];       # A35  FMC1_HPC_HA23_P
# # set_property -dict { PACKAGE_PIN A36 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA23_N }];       # A36  FMC1_HPC_HA23_N

# # # --- HB Bank ---
# # set_property -dict { PACKAGE_PIN J25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB00_CC_P }];    # J25  FMC1_HPC_HB00_CC_P
# # set_property -dict { PACKAGE_PIN J26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB00_CC_N }];    # J26  FMC1_HPC_HB00_CC_N
# # set_property -dict { PACKAGE_PIN H28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB01_P }];       # H28  FMC1_HPC_HB01_P
# # set_property -dict { PACKAGE_PIN H29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB01_N }];       # H29  FMC1_HPC_HB01_N
# # set_property -dict { PACKAGE_PIN K28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB02_P }];       # K28  FMC1_HPC_HB02_P
# # set_property -dict { PACKAGE_PIN J28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB02_N }];       # J28  FMC1_HPC_HB02_N
# # set_property -dict { PACKAGE_PIN G28 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB03_P }];       # G28  FMC1_HPC_HB03_P
# # set_property -dict { PACKAGE_PIN G29 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB03_N }];       # G29  FMC1_HPC_HB03_N
# # set_property -dict { PACKAGE_PIN H24 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB04_P }];       # H24  FMC1_HPC_HB04_P
# # set_property -dict { PACKAGE_PIN G24 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB04_N }];       # G24  FMC1_HPC_HB04_N
# # set_property -dict { PACKAGE_PIN K27 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB05_P }];       # K27  FMC1_HPC_HB05_P
# # set_property -dict { PACKAGE_PIN J27 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB05_N }];       # J27  FMC1_HPC_HB05_N
# # set_property -dict { PACKAGE_PIN K23 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB06_CC_P }];    # K23  FMC1_HPC_HB06_CC_P
# # set_property -dict { PACKAGE_PIN J23 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB06_CC_N }];    # J23  FMC1_HPC_HB06_CC_N
# # set_property -dict { PACKAGE_PIN G26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB07_P }];       # G26  FMC1_HPC_HB07_P
# # set_property -dict { PACKAGE_PIN G27 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB07_N }];       # G27  FMC1_HPC_HB07_N
# # set_property -dict { PACKAGE_PIN H25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB08_P }];       # H25  FMC1_HPC_HB08_P
# # set_property -dict { PACKAGE_PIN H26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB08_N }];       # H26  FMC1_HPC_HB08_N
# # set_property -dict { PACKAGE_PIN H23 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB09_P }];       # H23  FMC1_HPC_HB09_P
# # set_property -dict { PACKAGE_PIN G23 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB09_N }];       # G23  FMC1_HPC_HB09_N
# # set_property -dict { PACKAGE_PIN M22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB10_P }];       # M22  FMC1_HPC_HB10_P
# # set_property -dict { PACKAGE_PIN L22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB10_N }];       # L22  FMC1_HPC_HB10_N
# # set_property -dict { PACKAGE_PIN K22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB11_P }];       # K22  FMC1_HPC_HB11_P
# # set_property -dict { PACKAGE_PIN J22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB11_N }];       # J22  FMC1_HPC_HB11_N
# # set_property -dict { PACKAGE_PIN K24 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB12_P }];       # K24  FMC1_HPC_HB12_P
# # set_property -dict { PACKAGE_PIN K25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB12_N }];       # K25  FMC1_HPC_HB12_N
# # set_property -dict { PACKAGE_PIN P25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB13_P }];       # P25  FMC1_HPC_HB13_P
# # set_property -dict { PACKAGE_PIN P26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB13_N }];       # P26  FMC1_HPC_HB13_N
# # set_property -dict { PACKAGE_PIN J21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB14_P }];       # J21  FMC1_HPC_HB14_P
# # set_property -dict { PACKAGE_PIN H21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB14_N }];       # H21  FMC1_HPC_HB14_N
# # set_property -dict { PACKAGE_PIN M21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB15_P }];       # M21  FMC1_HPC_HB15_P
# # set_property -dict { PACKAGE_PIN L21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB15_N }];       # L21  FMC1_HPC_HB15_N
# # set_property -dict { PACKAGE_PIN N25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB16_P }];       # N25  FMC1_HPC_HB16_P
# # set_property -dict { PACKAGE_PIN N26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB16_N }];       # N26  FMC1_HPC_HB16_N
# # set_property -dict { PACKAGE_PIN M24 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB17_CC_P }];    # M24  FMC1_HPC_HB17_CC_P
# # set_property -dict { PACKAGE_PIN L24 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB17_CC_N }];    # L24  FMC1_HPC_HB17_CC_N
# # set_property -dict { PACKAGE_PIN G21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB18_P }];       # G21  FMC1_HPC_HB18_P
# # set_property -dict { PACKAGE_PIN G22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB18_N }];       # G22  FMC1_HPC_HB18_N
# # set_property -dict { PACKAGE_PIN L25 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB19_P }];       # L25  FMC1_HPC_HB19_P
# # set_property -dict { PACKAGE_PIN L26 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB19_N }];       # L26  FMC1_HPC_HB19_N
# # set_property -dict { PACKAGE_PIN P21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB20_P }];       # P21  FMC1_HPC_HB20_P
# # set_property -dict { PACKAGE_PIN N21 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB20_N }];       # N21  FMC1_HPC_HB20_N
# # set_property -dict { PACKAGE_PIN P22 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB21_P }];       # P22  FMC1_HPC_HB21_P
# # set_property -dict { PACKAGE_PIN P23 IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB21_N }];       # P23  FMC1_HPC_HB21_N
...
# # set_property PACKAGE_PIN W2 [get_ports PCIE_uart0_tx_P]
# # set_property PACKAGE_PIN Y4 [get_ports PCIE_uart0_rx_P]
# # set_property PACKAGE_PIN W1 [get_ports PCIE_uart0_tx_N]
# # set_property PACKAGE_PIN Y3 [get_ports PCIE_uart0_rx_N]
...
###########################################################################################################
######################################### NEW CONSTRAINTS START HERE ###########################################
###########################################################################################################


# # --- BỎ QUA TIMING CHO CÁC CHÂN VÀO CHẬM ---
# set_false_path -from [get_ports resetn]
# set_false_path -from [get_ports uart0_rx]
# set_false_path -from [get_ports uart1_rx]
# set_false_path -from [get_ports i2c0_sda]
# set_false_path -from [get_ports i2c1_sda]
# set_false_path -from [get_ports {gpio_io[*]}]

# # --- BỎ QUA TIMING CHO CÁC CHÂN RA CHẬM ---
# set_false_path -to [get_ports trap0]
# set_false_path -to [get_ports trap1]
# set_false_path -to [get_ports uart0_tx]
# set_false_path -to [get_ports uart1_tx]
# set_false_path -to [get_ports i2c0_scl]
# set_false_path -to [get_ports i2c1_scl]
# set_false_path -to [get_ports {gpio_io[*]}]
# set_false_path -to [get_ports hyperram0_resetn]
# set_false_path -to [get_ports hyperram1_resetn]

################################################################################
# 1. CLOCK CONSTRAINTS (200MHz)
################################################################################
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVDS} [get_ports clk_p]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVDS} [get_ports clk_n]
# create_clock -add -name sys_clk_pin -period 5.00 -waveform {0 2.5} [get_ports { clk_p }];
...
################################################################################
# -- Active --
set_property -dict {PACKAGE_PIN AV30 IOSTANDARD LVCMOS18} [get_ports resetn]

# -- Inactive (Commented) --
# set_property -dict { PACKAGE_PIN AY33 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW1 }];     # GPIO_DIP_SW1
# set_property -dict { PACKAGE_PIN BA31 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW2 }];     # GPIO_DIP_SW2
# set_property -dict { PACKAGE_PIN BA32 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW3 }];     # GPIO_DIP_SW3
# set_property -dict { PACKAGE_PIN AW30 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW4 }];     # GPIO_DIP_SW4
# set_property -dict { PACKAGE_PIN AY30 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW5 }];     # GPIO_DIP_SW5
# set_property -dict { PACKAGE_PIN BA30 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW6 }];     # GPIO_DIP_SW6
# set_property -dict { PACKAGE_PIN BB31 IOSTANDARD LVCMOS18 } [get_ports { GPIO_DIP_SW7 }];     # GPIO_DIP_SW7

################################################################################
# 3. SYSTEM STATUS (LEDs & Push Buttons)
################################################################################
# -- Active --
set_property -dict {PACKAGE_PIN AM39 IOSTANDARD LVCMOS18} [get_ports trap0]
set_property -dict {PACKAGE_PIN AN39 IOSTANDARD LVCMOS18} [get_ports trap1]

# -- Inactive LEDs (Commented) --
# set_property -dict { PACKAGE_PIN AR37 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_2_LS }];    # GPIO_LED_2_LS
# set_property -dict { PACKAGE_PIN AT37 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_3_LS }];    # GPIO_LED_3_LS
# set_property -dict { PACKAGE_PIN AR35 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_4_LS }];    # GPIO_LED_4_LS
# set_property -dict { PACKAGE_PIN AP41 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_5_LS }];    # GPIO_LED_5_LS
# set_property -dict { PACKAGE_PIN AP42 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_6_LS }];    # GPIO_LED_6_LS
# set_property -dict { PACKAGE_PIN AU39 IOSTANDARD LVCMOS18 } [get_ports { GPIO_LED_7_LS }];    # GPIO_LED_7_LS

# -- Inactive Push Buttons (Commented) --
# set_property -dict { PACKAGE_PIN AV39 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_C }];        # GPIO_SW_C
# set_property -dict { PACKAGE_PIN AP40 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_S }];        # GPIO_SW_S
# set_property -dict { PACKAGE_PIN AR40 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_N }];        # GPIO_SW_N
# set_property -dict { PACKAGE_PIN AU38 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_E }];        # GPIO_SW_E
# set_property -dict { PACKAGE_PIN AW40 IOSTANDARD LVCMOS18 } [get_ports { GPIO_SW_W }];        # GPIO_SW_W
...
# ======================== FMC1 ACTIVE PINS ========================
# -- hyperram Data --
set_property -dict {PACKAGE_PIN N28 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[0]}]
set_property -dict {PACKAGE_PIN W30 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[1]}]
set_property -dict {PACKAGE_PIN P31 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[2]}]
set_property -dict {PACKAGE_PIN N29 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[3]}]
set_property -dict {PACKAGE_PIN R30 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[4]}]
set_property -dict {PACKAGE_PIN W31 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[5]}]
set_property -dict {PACKAGE_PIN L37 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[6]}]
set_property -dict {PACKAGE_PIN M36 IOSTANDARD LVCMOS18} [get_ports {hyperram0_dq_io[7]}]
# -- hyperram Control --
set_property -dict {PACKAGE_PIN L29 IOSTANDARD LVCMOS18} [get_ports hyperram0_rwds_io]
set_property -dict {PACKAGE_PIN L30 IOSTANDARD LVCMOS18} [get_ports hyperram0_cs_n]
set_property -dict {PACKAGE_PIN V30 IOSTANDARD LVCMOS18} [get_ports hyperram0_hclk_p]
# set_property -dict { PACKAGE_PIN V31  IOSTANDARD LVCMOS18 } [get_ports { hyperram0_hclk_n }];      # FMC1_HPC_LA30_N
set_property -dict {PACKAGE_PIN V29 IOSTANDARD LVCMOS18} [get_ports hyperram0_resetn]


# ======================== FMC1: HDMI TX ========================
# -- HDMI Data --
set_property -dict {PACKAGE_PIN K39 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[0]}]
set_property -dict {PACKAGE_PIN K40 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[1]}]
set_property -dict {PACKAGE_PIN P41 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[2]}]
set_property -dict {PACKAGE_PIN N41 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[3]}]
set_property -dict {PACKAGE_PIN M42 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[4]}]
set_property -dict {PACKAGE_PIN L42 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[5]}]
set_property -dict {PACKAGE_PIN H40 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[6]}]
set_property -dict {PACKAGE_PIN H41 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[7]}]
set_property -dict {PACKAGE_PIN M37 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[8]}]
set_property -dict {PACKAGE_PIN M38 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[9]}]
set_property -dict {PACKAGE_PIN G41 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[10]}]
set_property -dict {PACKAGE_PIN G42 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[11]}]
set_property -dict {PACKAGE_PIN R40 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[12]}]
set_property -dict {PACKAGE_PIN P40 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[13]}]
set_property -dict {PACKAGE_PIN F40 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[14]}]
set_property -dict {PACKAGE_PIN F41 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[15]}]
set_property -dict {PACKAGE_PIN J31 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[16]}]
set_property -dict {PACKAGE_PIN H31 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[17]}]
set_property -dict {PACKAGE_PIN L31 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[18]}]
set_property -dict {PACKAGE_PIN K32 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[19]}]
set_property -dict {PACKAGE_PIN P30 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[20]}]
set_property -dict {PACKAGE_PIN N31 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[21]}]
set_property -dict {PACKAGE_PIN J30 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[22]}]
set_property -dict {PACKAGE_PIN H30 IOSTANDARD LVCMOS18} [get_ports {HDMI_TX_D[23]}]

# -- HDMI Control --
set_property -dict {PACKAGE_PIN M41 IOSTANDARD LVCMOS18} [get_ports HDMI_TX_HS]
set_property -dict {PACKAGE_PIN L41 IOSTANDARD LVCMOS18} [get_ports HDMI_TX_VS]
set_property -dict {PACKAGE_PIN N38 IOSTANDARD LVCMOS18} [get_ports HDMI_TX_DE]
set_property -dict {PACKAGE_PIN N30 IOSTANDARD LVCMOS18} [get_ports HDMI_TX_CLK]

# ======================= FMC1 INACTIVE PINS =======================
# --- LA Bank ---
# set_property -dict { PACKAGE_PIN K39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA00_CC_P }];   # FMC1_HPC_LA00_CC_P
# set_property -dict { PACKAGE_PIN K40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA00_CC_N }];   # FMC1_HPC_LA00_CC_N
# set_property -dict { PACKAGE_PIN J40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_P }];   # FMC1_HPC_LA01_CC_P
# set_property -dict { PACKAGE_PIN J41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA01_CC_N }];   # FMC1_HPC_LA01_CC_N
# set_property -dict { PACKAGE_PIN P41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA02_P }];      # FMC1_HPC_LA02_P
# set_property -dict { PACKAGE_PIN N41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA02_N }];      # FMC1_HPC_LA02_N
# set_property -dict { PACKAGE_PIN M42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA03_P }];      # FMC1_HPC_LA03_P
# set_property -dict { PACKAGE_PIN L42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA03_N }];      # FMC1_HPC_LA03_N
# set_property -dict { PACKAGE_PIN H40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA04_P }];      # FMC1_HPC_LA04_P
# set_property -dict { PACKAGE_PIN H41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA04_N }];      # FMC1_HPC_LA04_N
# set_property -dict { PACKAGE_PIN M41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA05_P }];      # FMC1_HPC_LA05_P
# set_property -dict { PACKAGE_PIN L41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA05_N }];      # FMC1_HPC_LA05_N
# set_property -dict { PACKAGE_PIN K42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA06_P }];      # FMC1_HPC_LA06_P
# set_property -dict { PACKAGE_PIN J42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA06_N }];      # FMC1_HPC_LA06_N
# set_property -dict { PACKAGE_PIN G41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA07_P }];      # FMC1_HPC_LA07_P
# set_property -dict { PACKAGE_PIN G42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA07_N }];      # FMC1_HPC_LA07_N
# set_property -dict { PACKAGE_PIN M37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA08_P }];      # FMC1_HPC_LA08_P
# set_property -dict { PACKAGE_PIN M38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA08_N }];      # FMC1_HPC_LA08_N
# set_property -dict { PACKAGE_PIN R42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_P }];      # FMC1_HPC_LA09_P
# set_property -dict { PACKAGE_PIN P42  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA09_N }];      # FMC1_HPC_LA09_N
# set_property -dict { PACKAGE_PIN N38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA10_P }];      # FMC1_HPC_LA10_P
# set_property -dict { PACKAGE_PIN M39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA10_N }];      # FMC1_HPC_LA10_N
# set_property -dict { PACKAGE_PIN F40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA11_P }];      # FMC1_HPC_LA11_P
# set_property -dict { PACKAGE_PIN F41  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA11_N }];      # FMC1_HPC_LA11_N
# set_property -dict { PACKAGE_PIN R40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA12_P }];      # FMC1_HPC_LA12_P
# set_property -dict { PACKAGE_PIN P40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA12_N }];      # FMC1_HPC_LA12_N
# set_property -dict { PACKAGE_PIN H39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA13_P }];      # FMC1_HPC_LA13_P
# set_property -dict { PACKAGE_PIN G39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA13_N }];      # FMC1_HPC_LA13_N
# set_property -dict { PACKAGE_PIN N39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_P }];      # FMC1_HPC_LA14_P
# set_property -dict { PACKAGE_PIN N40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA14_N }];      # FMC1_HPC_LA14_N
# set_property -dict { PACKAGE_PIN K37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_P }];      # FMC1_HPC_LA16_P
# set_property -dict { PACKAGE_PIN K38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA16_N }];      # FMC1_HPC_LA16_N
# set_property -dict { PACKAGE_PIN L31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA17_CC_P }];   # FMC1_HPC_LA17_CC_P
# set_property -dict { PACKAGE_PIN K32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA17_CC_N }];   # FMC1_HPC_LA17_CC_N
# set_property -dict { PACKAGE_PIN M32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA18_CC_P }];   # FMC1_HPC_LA18_CC_P
# set_property -dict { PACKAGE_PIN L32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA18_CC_N }];   # FMC1_HPC_LA18_CC_N
# set_property -dict { PACKAGE_PIN Y29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA20_P }];      # FMC1_HPC_LA20_P
# set_property -dict { PACKAGE_PIN Y30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA20_N }];      # FMC1_HPC_LA20_N
# set_property -dict { PACKAGE_PIN R28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA22_P }];      # FMC1_HPC_LA22_P
# set_property -dict { PACKAGE_PIN P28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA22_N }];      # FMC1_HPC_LA22_N
# set_property -dict { PACKAGE_PIN P30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA23_P }];      # FMC1_HPC_LA23_P
# set_property -dict { PACKAGE_PIN N31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA23_N }];      # FMC1_HPC_LA23_N
# set_property -dict { PACKAGE_PIN K29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA25_P }];      # FMC1_HPC_LA25_P
# set_property -dict { PACKAGE_PIN K30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA25_N }];      # FMC1_HPC_LA25_N
# set_property -dict { PACKAGE_PIN J30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA26_P }];      # FMC1_HPC_LA26_P
# set_property -dict { PACKAGE_PIN H30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA26_N }];      # FMC1_HPC_LA26_N
# set_property -dict { PACKAGE_PIN J31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA27_P }];      # FMC1_HPC_LA27_P
# set_property -dict { PACKAGE_PIN H31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA27_N }];      # FMC1_HPC_LA27_N
# set_property -dict { PACKAGE_PIN T29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA29_P }];      # FMC1_HPC_LA29_P
# set_property -dict { PACKAGE_PIN T30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA29_N }];      # FMC1_HPC_LA29_N
# set_property -dict { PACKAGE_PIN M28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA31_P }];      # FMC1_HPC_LA31_P
# set_property -dict { PACKAGE_PIN M29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA31_N }];      # FMC1_HPC_LA31_N
# set_property -dict { PACKAGE_PIN U29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA32_N }];      # FMC1_HPC_LA32_N
# set_property -dict { PACKAGE_PIN U31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA33_P }];      # FMC1_HPC_LA33_P
# set_property -dict { PACKAGE_PIN T31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_LA33_N }];      # FMC1_HPC_LA33_N
# set_property -dict { PACKAGE_PIN L39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_P }];  # FMC1_HPC_CLK0_M2C_P
# set_property -dict { PACKAGE_PIN L40  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK0_M2C_N }];  # FMC1_HPC_CLK0_M2C_N
# set_property -dict { PACKAGE_PIN N30  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK1_M2C_P }];  # FMC1_HPC_CLK1_M2C_P
# set_property -dict { PACKAGE_PIN M31  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_CLK1_M2C_N }];  # FMC1_HPC_CLK1_M2C_N

# --- HA Bank ---
# set_property -dict { PACKAGE_PIN E34  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA00_CC_P }];   # FMC1_HPC_HA00_CC_P
# set_property -dict { PACKAGE_PIN E35  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA00_CC_N }];   # FMC1_HPC_HA00_CC_N
# set_property -dict { PACKAGE_PIN D35  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA01_CC_P }];   # FMC1_HPC_HA01_CC_P
# set_property -dict { PACKAGE_PIN D36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA01_CC_N }];   # FMC1_HPC_HA01_CC_N
# set_property -dict { PACKAGE_PIN E33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA02_P }];      # FMC1_HPC_HA02_P
# set_property -dict { PACKAGE_PIN D33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA02_N }];      # FMC1_HPC_HA02_N
# set_property -dict { PACKAGE_PIN H33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA03_P }];      # FMC1_HPC_HA03_P
# set_property -dict { PACKAGE_PIN G33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA03_N }];      # FMC1_HPC_HA03_N
# set_property -dict { PACKAGE_PIN F34  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA04_P }];      # FMC1_HPC_HA04_P
# set_property -dict { PACKAGE_PIN F35  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA04_N }];      # FMC1_HPC_HA04_N
# set_property -dict { PACKAGE_PIN G32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA05_P }];      # FMC1_HPC_HA05_P
# set_property -dict { PACKAGE_PIN F32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA05_N }];      # FMC1_HPC_HA05_N
# set_property -dict { PACKAGE_PIN G36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA06_P }];      # FMC1_HPC_HA06_P
# set_property -dict { PACKAGE_PIN G37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA06_N }];      # FMC1_HPC_HA06_N
# set_property -dict { PACKAGE_PIN C38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA07_P }];      # FMC1_HPC_HA07_P
# set_property -dict { PACKAGE_PIN C39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA07_N }];      # FMC1_HPC_HA07_N
# set_property -dict { PACKAGE_PIN J36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA08_P }];      # FMC1_HPC_HA08_P
# set_property -dict { PACKAGE_PIN H36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA08_N }];      # FMC1_HPC_HA08_N
# set_property -dict { PACKAGE_PIN E32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA09_P }];      # FMC1_HPC_HA09_P
# set_property -dict { PACKAGE_PIN D32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA09_N }];      # FMC1_HPC_HA09_N
# set_property -dict { PACKAGE_PIN H38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA10_P }];      # FMC1_HPC_HA10_P
# set_property -dict { PACKAGE_PIN G38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA10_N }];      # FMC1_HPC_HA10_N
# set_property -dict { PACKAGE_PIN J37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA11_P }];      # FMC1_HPC_HA11_P
# set_property -dict { PACKAGE_PIN J38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA11_N }];      # FMC1_HPC_HA11_N
# set_property -dict { PACKAGE_PIN B37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA12_P }];      # FMC1_HPC_HA12_P
# set_property -dict { PACKAGE_PIN B38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA12_N }];      # FMC1_HPC_HA12_N
# set_property -dict { PACKAGE_PIN B36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA13_P }];      # FMC1_HPC_HA13_P
# set_property -dict { PACKAGE_PIN A37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA13_N }];      # FMC1_HPC_HA13_N
# set_property -dict { PACKAGE_PIN E37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA14_P }];      # FMC1_HPC_HA14_P
# set_property -dict { PACKAGE_PIN E38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA14_N }];      # FMC1_HPC_HA14_N
# set_property -dict { PACKAGE_PIN C33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA15_P }];      # FMC1_HPC_HA15_P
# set_property -dict { PACKAGE_PIN C34  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA15_N }];      # FMC1_HPC_HA15_N
# set_property -dict { PACKAGE_PIN B39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA16_P }];      # FMC1_HPC_HA16_P
# set_property -dict { PACKAGE_PIN A39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA16_N }];      # FMC1_HPC_HA16_N
# set_property -dict { PACKAGE_PIN C35  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA17_CC_P }];   # FMC1_HPC_HA17_CC_P
# set_property -dict { PACKAGE_PIN C36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA17_CC_N }];   # FMC1_HPC_HA17_CC_N
# set_property -dict { PACKAGE_PIN F39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA18_P }];      # FMC1_HPC_HA18_P
# set_property -dict { PACKAGE_PIN E39  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA18_N }];      # FMC1_HPC_HA18_N
# set_property -dict { PACKAGE_PIN B32  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA19_P }];      # FMC1_HPC_HA19_P
# set_property -dict { PACKAGE_PIN B33  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA19_N }];      # FMC1_HPC_HA19_N
# set_property -dict { PACKAGE_PIN B34  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA20_P }];      # FMC1_HPC_HA20_P
# set_property -dict { PACKAGE_PIN A34  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA20_N }];      # FMC1_HPC_HA20_N
# set_property -dict { PACKAGE_PIN D37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA21_P }];      # FMC1_HPC_HA21_P
# set_property -dict { PACKAGE_PIN D38  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA21_N }];      # FMC1_HPC_HA21_N
# set_property -dict { PACKAGE_PIN F36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA22_P }];      # FMC1_HPC_HA22_P
# set_property -dict { PACKAGE_PIN F37  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA22_N }];      # FMC1_HPC_HA22_N
# set_property -dict { PACKAGE_PIN A35  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA23_P }];      # FMC1_HPC_HA23_P
# set_property -dict { PACKAGE_PIN A36  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HA23_N }];      # FMC1_HPC_HA23_N

# --- HB Bank ---
# set_property -dict { PACKAGE_PIN J25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB00_CC_P }];   # FMC1_HPC_HB00_CC_P
# set_property -dict { PACKAGE_PIN J26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB00_CC_N }];   # FMC1_HPC_HB00_CC_N
# set_property -dict { PACKAGE_PIN H28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB01_P }];      # FMC1_HPC_HB01_P
# set_property -dict { PACKAGE_PIN H29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB01_N }];      # FMC1_HPC_HB01_N
# set_property -dict { PACKAGE_PIN K28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB02_P }];      # FMC1_HPC_HB02_P
# set_property -dict { PACKAGE_PIN J28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB02_N }];      # FMC1_HPC_HB02_N
# set_property -dict { PACKAGE_PIN G28  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB03_P }];      # FMC1_HPC_HB03_P
# set_property -dict { PACKAGE_PIN G29  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB03_N }];      # FMC1_HPC_HB03_N
# set_property -dict { PACKAGE_PIN H24  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB04_P }];      # FMC1_HPC_HB04_P
# set_property -dict { PACKAGE_PIN G24  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB04_N }];      # FMC1_HPC_HB04_N
# set_property -dict { PACKAGE_PIN K27  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB05_P }];      # FMC1_HPC_HB05_P
# set_property -dict { PACKAGE_PIN J27  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB05_N }];      # FMC1_HPC_HB05_N
# set_property -dict { PACKAGE_PIN K23  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB06_CC_P }];   # FMC1_HPC_HB06_CC_P
# set_property -dict { PACKAGE_PIN J23  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB06_CC_N }];   # FMC1_HPC_HB06_CC_N
# set_property -dict { PACKAGE_PIN G26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB07_P }];      # FMC1_HPC_HB07_P
# set_property -dict { PACKAGE_PIN G27  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB07_N }];      # FMC1_HPC_HB07_N
# set_property -dict { PACKAGE_PIN H25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB08_P }];      # FMC1_HPC_HB08_P
# set_property -dict { PACKAGE_PIN H26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB08_N }];      # FMC1_HPC_HB08_N
# set_property -dict { PACKAGE_PIN H23  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB09_P }];      # FMC1_HPC_HB09_P
# set_property -dict { PACKAGE_PIN G23  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB09_N }];      # FMC1_HPC_HB09_N
# set_property -dict { PACKAGE_PIN M22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB10_P }];      # FMC1_HPC_HB10_P
# set_property -dict { PACKAGE_PIN L22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB10_N }];      # FMC1_HPC_HB10_N
# set_property -dict { PACKAGE_PIN K22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB11_P }];      # FMC1_HPC_HB11_P
# set_property -dict { PACKAGE_PIN J22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB11_N }];      # FMC1_HPC_HB11_N
# set_property -dict { PACKAGE_PIN K24  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB12_P }];      # FMC1_HPC_HB12_P
# set_property -dict { PACKAGE_PIN K25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB12_N }];      # FMC1_HPC_HB12_N
# set_property -dict { PACKAGE_PIN P25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB13_P }];      # FMC1_HPC_HB13_P
# set_property -dict { PACKAGE_PIN P26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB13_N }];      # FMC1_HPC_HB13_N
# set_property -dict { PACKAGE_PIN J21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB14_P }];      # FMC1_HPC_HB14_P
# set_property -dict { PACKAGE_PIN H21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB14_N }];      # FMC1_HPC_HB14_N
# set_property -dict { PACKAGE_PIN M21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB15_P }];      # FMC1_HPC_HB15_P
# set_property -dict { PACKAGE_PIN L21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB15_N }];      # FMC1_HPC_HB15_N
# set_property -dict { PACKAGE_PIN N25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB16_P }];      # FMC1_HPC_HB16_P
# set_property -dict { PACKAGE_PIN N26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB16_N }];      # FMC1_HPC_HB16_N
# set_property -dict { PACKAGE_PIN M24  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB17_CC_P }];   # FMC1_HPC_HB17_CC_P
# set_property -dict { PACKAGE_PIN L24  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB17_CC_N }];   # FMC1_HPC_HB17_CC_N
# set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB18_P }];      # FMC1_HPC_HB18_P
# set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB18_N }];      # FMC1_HPC_HB18_N
# set_property -dict { PACKAGE_PIN L25  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB19_P }];      # FMC1_HPC_HB19_P
# set_property -dict { PACKAGE_PIN L26  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB19_N }];      # FMC1_HPC_HB19_N
# set_property -dict { PACKAGE_PIN P21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB20_P }];      # FMC1_HPC_HB20_P
# set_property -dict { PACKAGE_PIN N21  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB20_N }];      # FMC1_HPC_HB20_N
# set_property -dict { PACKAGE_PIN P22  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB21_P }];      # FMC1_HPC_HB21_P
# set_property -dict { PACKAGE_PIN P23  IOSTANDARD LVCMOS18 } [get_ports { FMC1_HPC_HB21_N }];      # FMC1_HPC_HB21_N
...
# ======================== FMC2 ACTIVE PINS ========================
# -- GPIO --
set_property -dict {PACKAGE_PIN W40 IOSTANDARD LVCMOS18} [get_ports {gpio_io[0]}]
set_property -dict {PACKAGE_PIN Y40 IOSTANDARD LVCMOS18} [get_ports {gpio_io[1]}]
set_property -dict {PACKAGE_PIN U37 IOSTANDARD LVCMOS18} [get_ports {gpio_io[2]}]
set_property -dict {PACKAGE_PIN U38 IOSTANDARD LVCMOS18} [get_ports {gpio_io[3]}]
set_property -dict {PACKAGE_PIN U36 IOSTANDARD LVCMOS18} [get_ports {gpio_io[4]}]
set_property -dict {PACKAGE_PIN T37 IOSTANDARD LVCMOS18} [get_ports {gpio_io[5]}]
set_property -dict {PACKAGE_PIN P32 IOSTANDARD LVCMOS18} [get_ports {gpio_io[6]}]
set_property -dict {PACKAGE_PIN P33 IOSTANDARD LVCMOS18} [get_ports {gpio_io[7]}]

# -- UART --
set_property -dict {PACKAGE_PIN AJ38 IOSTANDARD LVCMOS18} [get_ports uart0_rx]
set_property -dict {PACKAGE_PIN AK38 IOSTANDARD LVCMOS18} [get_ports uart0_tx]
# set_property -dict { PACKAGE_PIN AB38 IOSTANDARD LVCMOS18 } [get_ports { uart1_rx }];           # FMC2_HPC_LA14_P
# set_property -dict { PACKAGE_PIN AB39 IOSTANDARD LVCMOS18 } [get_ports { uart1_tx }];           # FMC2_HPC_LA14_N

# -- I2C --
set_property -dict {PACKAGE_PIN AK39 IOSTANDARD LVCMOS18} [get_ports i2c0_scl]
set_property -dict {PACKAGE_PIN AL39 IOSTANDARD LVCMOS18} [get_ports i2c0_sda]
# set_property -dict { PACKAGE_PIN AC40 IOSTANDARD LVCMOS18 } [get_ports { i2c1_scl }];           # FMC2_HPC_LA07_P
# set_property -dict { PACKAGE_PIN AC41 IOSTANDARD LVCMOS18 } [get_ports { i2c1_sda }];           # FMC2_HPC_LA07_N

# -- SPI --
set_property -dict {PACKAGE_PIN AF41 IOSTANDARD LVCMOS18} [get_ports spi0_clk]
set_property -dict {PACKAGE_PIN AG41 IOSTANDARD LVCMOS18} [get_ports spi0_mosi]
set_property -dict {PACKAGE_PIN AF42 IOSTANDARD LVCMOS18} [get_ports spi0_miso]
set_property -dict {PACKAGE_PIN AG42 IOSTANDARD LVCMOS18} [get_ports spi0_ss_n]
set_property -dict { PACKAGE_PIN AD38 IOSTANDARD LVCMOS18 } [get_ports { spi1_clk }];           # FMC2_HPC_LA06_P
set_property -dict { PACKAGE_PIN AE38 IOSTANDARD LVCMOS18 } [get_ports { spi1_mosi }];          # FMC2_HPC_LA06_N
set_property -dict { PACKAGE_PIN AB41 IOSTANDARD LVCMOS18 } [get_ports { spi1_miso }];          # FMC2_HPC_LA10_P
set_property -dict { PACKAGE_PIN AB42 IOSTANDARD LVCMOS18 } [get_ports { spi1_ss_n }];          # FMC2_HPC_LA10_N

# -- hyperram 1 (Mapped equivalent to hyperram 0 FMC1) --
set_property -dict {PACKAGE_PIN P35 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[0]}]
set_property -dict {PACKAGE_PIN U32 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[1]}]
set_property -dict {PACKAGE_PIN T35 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[2]}]
set_property -dict {PACKAGE_PIN P36 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[3]}]
set_property -dict {PACKAGE_PIN U34 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[4]}]
set_property -dict {PACKAGE_PIN U33 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[5]}]
set_property -dict {PACKAGE_PIN AC39 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[6]}]
set_property -dict {PACKAGE_PIN AC38 IOSTANDARD LVCMOS18} [get_ports {hyperram1_dq_io[7]}]
set_property -dict {PACKAGE_PIN V35 IOSTANDARD LVCMOS18} [get_ports hyperram1_rwds_io]
set_property -dict {PACKAGE_PIN V36 IOSTANDARD LVCMOS18} [get_ports hyperram1_cs_n]
set_property -dict {PACKAGE_PIN T32 IOSTANDARD LVCMOS18} [get_ports hyperram1_hclk_p]
# set_property -dict { PACKAGE_PIN R32  IOSTANDARD LVCMOS18 } [get_ports { hyperram1_hclk_n }];      # FMC2_HPC_LA30_N
set_property -dict {PACKAGE_PIN P37 IOSTANDARD LVCMOS18} [get_ports hyperram1_resetn]

# ======================== FMC2: CAMERA ========================
# -- Camera Data --
set_property -dict {PACKAGE_PIN AA39 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[0]}]
set_property -dict {PACKAGE_PIN Y39 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[1]}]
set_property -dict {PACKAGE_PIN AK42 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[2]}]
set_property -dict {PACKAGE_PIN AJ42 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[3]}]
set_property -dict {PACKAGE_PIN AD41 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[4]}]
set_property -dict {PACKAGE_PIN AD40 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[5]}]
set_property -dict {PACKAGE_PIN AA42 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[6]}]
set_property -dict {PACKAGE_PIN Y42 IOSTANDARD LVCMOS18} [get_ports {cam_half_pixel_i[7]}]

# -- Camera Control & Clock --
set_property -dict {PACKAGE_PIN AL41 IOSTANDARD LVCMOS18} [get_ports cam_vsync]
set_property -dict {PACKAGE_PIN AL42 IOSTANDARD LVCMOS18} [get_ports cam_href]
set_property -dict {PACKAGE_PIN AF39 IOSTANDARD LVCMOS18} [get_ports cam_pclk_i]
set_property -dict {PACKAGE_PIN AF40 IOSTANDARD LVCMOS18} [get_ports cam_xclk_o]
...
# ======================= FMC2 INACTIVE PINS =======================
# --- LA Bank ---
# set_property -dict { PACKAGE_PIN AD40 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA00_CC_P }];   # FMC2_HPC_LA00_CC_P
# set_property -dict { PACKAGE_PIN AD41 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA00_CC_N }];   # FMC2_HPC_LA00_CC_N
# set_property -dict { PACKAGE_PIN AJ42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA03_P }];      # FMC2_HPC_LA03_P
# set_property -dict { PACKAGE_PIN AK42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA03_N }];      # FMC2_HPC_LA03_N
# set_property -dict { PACKAGE_PIN AL41 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA04_P }];      # FMC2_HPC_LA04_P
# set_property -dict { PACKAGE_PIN AL42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA04_N }];      # FMC2_HPC_LA04_N
# set_property -dict { PACKAGE_PIN AD42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA08_P }];      # FMC2_HPC_LA08_P
# set_property -dict { PACKAGE_PIN AE42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA08_N }];      # FMC2_HPC_LA08_N
# set_property -dict { PACKAGE_PIN Y42  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA11_P }];      # FMC2_HPC_LA11_P
# set_property -dict { PACKAGE_PIN AA42 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA11_N }];      # FMC2_HPC_LA11_N
# set_property -dict { PACKAGE_PIN Y39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA12_P }];      # FMC2_HPC_LA12_P
# set_property -dict { PACKAGE_PIN AA39 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA12_N }];      # FMC2_HPC_LA12_N
# set_property -dict { PACKAGE_PIN AJ40 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA16_P }];      # FMC2_HPC_LA16_P
# set_property -dict { PACKAGE_PIN AJ41 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA16_N }];      # FMC2_HPC_LA16_N
# set_property -dict { PACKAGE_PIN V33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA20_P }];      # FMC2_HPC_LA20_P
# set_property -dict { PACKAGE_PIN V34  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA20_N }];      # FMC2_HPC_LA20_N
# set_property -dict { PACKAGE_PIN W32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA22_P }];      # FMC2_HPC_LA22_P
# set_property -dict { PACKAGE_PIN W33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA22_N }];      # FMC2_HPC_LA22_N
# set_property -dict { PACKAGE_PIN R38  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA23_P }];      # FMC2_HPC_LA23_P
# set_property -dict { PACKAGE_PIN R39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA23_N }];      # FMC2_HPC_LA23_N
# set_property -dict { PACKAGE_PIN R33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA25_P }];      # FMC2_HPC_LA25_P
# set_property -dict { PACKAGE_PIN R34  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA25_N }];      # FMC2_HPC_LA25_N
# set_property -dict { PACKAGE_PIN N33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA26_P }];      # FMC2_HPC_LA26_P
# set_property -dict { PACKAGE_PIN N34  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA26_N }];      # FMC2_HPC_LA26_N
# set_property -dict { PACKAGE_PIN W36  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA29_P }];      # FMC2_HPC_LA29_P
# set_property -dict { PACKAGE_PIN W37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA29_N }];      # FMC2_HPC_LA29_N
# set_property -dict { PACKAGE_PIN V39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA31_P }];      # FMC2_HPC_LA31_P
# set_property -dict { PACKAGE_PIN V40  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA31_N }];      # FMC2_HPC_LA31_N
# set_property -dict { PACKAGE_PIN P38  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA32_N }];      # FMC2_HPC_LA32_N
# set_property -dict { PACKAGE_PIN T36  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA33_P }];      # FMC2_HPC_LA33_P
# set_property -dict { PACKAGE_PIN R37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_LA33_N }];      # FMC2_HPC_LA33_N
# set_property -dict { PACKAGE_PIN AF39 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK0_M2C_P }];  # FMC2_HPC_CLK0_M2C_P
# set_property -dict { PACKAGE_PIN AF40 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK0_M2C_N }];  # FMC2_HPC_CLK0_M2C_N
# set_property -dict { PACKAGE_PIN U39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK1_M2C_P }];  # FMC2_HPC_CLK1_M2C_P
# set_property -dict { PACKAGE_PIN T39  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_CLK1_M2C_N }];  # FMC2_HPC_CLK1_M2C_N

# --- HA Bank ---
# set_property -dict { PACKAGE_PIN AB33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA00_CC_P }];   # FMC2_HPC_HA00_CC_P
# set_property -dict { PACKAGE_PIN AC33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA00_CC_N }];   # FMC2_HPC_HA00_CC_N
# set_property -dict { PACKAGE_PIN AD32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA01_CC_P }];   # FMC2_HPC_HA01_CC_P
# set_property -dict { PACKAGE_PIN AD33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA01_CC_N }];   # FMC2_HPC_HA01_CC_N
# set_property -dict { PACKAGE_PIN AC30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA02_P }];      # FMC2_HPC_HA02_P
# set_property -dict { PACKAGE_PIN AD30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA02_N }];      # FMC2_HPC_HA02_N
# set_property -dict { PACKAGE_PIN AA29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA03_P }];      # FMC2_HPC_HA03_P
# set_property -dict { PACKAGE_PIN AA30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA03_N }];      # FMC2_HPC_HA03_N
# set_property -dict { PACKAGE_PIN AB29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA04_P }];      # FMC2_HPC_HA04_P
# set_property -dict { PACKAGE_PIN AC29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA04_N }];      # FMC2_HPC_HA04_N
# set_property -dict { PACKAGE_PIN Y32  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA05_P }];      # FMC2_HPC_HA05_P
# set_property -dict { PACKAGE_PIN Y33  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA05_N }];      # FMC2_HPC_HA05_N
# set_property -dict { PACKAGE_PIN AB31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA06_P }];      # FMC2_HPC_HA06_P
# set_property -dict { PACKAGE_PIN AB32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA06_N }];      # FMC2_HPC_HA06_N
# set_property -dict { PACKAGE_PIN AC31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA07_P }];      # FMC2_HPC_HA07_P
# set_property -dict { PACKAGE_PIN AD31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA07_N }];      # FMC2_HPC_HA07_N
# set_property -dict { PACKAGE_PIN AA31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA08_P }];      # FMC2_HPC_HA08_P
# set_property -dict { PACKAGE_PIN AA32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA08_N }];      # FMC2_HPC_HA08_N
# set_property -dict { PACKAGE_PIN AE29 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA09_P }];      # FMC2_HPC_HA09_P
# set_property -dict { PACKAGE_PIN AE30 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA09_N }];      # FMC2_HPC_HA09_N
# set_property -dict { PACKAGE_PIN AF31 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA10_P }];      # FMC2_HPC_HA10_P
# set_property -dict { PACKAGE_PIN AF32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA10_N }];      # FMC2_HPC_HA10_N
# set_property -dict { PACKAGE_PIN AE34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA11_P }];      # FMC2_HPC_HA11_P
# set_property -dict { PACKAGE_PIN AE35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA11_N }];      # FMC2_HPC_HA11_N
# set_property -dict { PACKAGE_PIN AF34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA12_P }];      # FMC2_HPC_HA12_P
# set_property -dict { PACKAGE_PIN AG34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA12_N }];      # FMC2_HPC_HA12_N
# set_property -dict { PACKAGE_PIN AE32 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA13_P }];      # FMC2_HPC_HA13_P
# set_property -dict { PACKAGE_PIN AE33 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA13_N }];      # FMC2_HPC_HA13_N
# set_property -dict { PACKAGE_PIN AF35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA14_P }];      # FMC2_HPC_HA14_P
# set_property -dict { PACKAGE_PIN AF36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA14_N }];      # FMC2_HPC_HA14_N
# set_property -dict { PACKAGE_PIN AE37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_P }];      # FMC2_HPC_HA15_P
# set_property -dict { PACKAGE_PIN AF37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_N }];      # FMC2_HPC_HA15_N
# set_property -dict { PACKAGE_PIN AG36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA16_P }];      # FMC2_HPC_HA16_P
# set_property -dict { PACKAGE_PIN AH36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA16_N }];      # FMC2_HPC_HA16_N
# set_property -dict { PACKAGE_PIN AC34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA17_CC_P }];   # FMC2_HPC_HA17_CC_P
# set_property -dict { PACKAGE_PIN AD35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA17_CC_N }];   # FMC2_HPC_HA17_CC_N
# set_property -dict { PACKAGE_PIN AB36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA18_P }];      # FMC2_HPC_HA18_P
# set_property -dict { PACKAGE_PIN AB37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA18_N }];      # FMC2_HPC_HA18_N
# set_property -dict { PACKAGE_PIN AC35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA19_P }];      # FMC2_HPC_HA19_P
# set_property -dict { PACKAGE_PIN AC36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA19_N }];      # FMC2_HPC_HA19_N
# set_property -dict { PACKAGE_PIN AD36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA20_P }];      # FMC2_HPC_HA20_P
# set_property -dict { PACKAGE_PIN AD37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA20_N }];      # FMC2_HPC_HA20_N
# set_property -dict { PACKAGE_PIN AA34 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA21_P }];      # FMC2_HPC_HA21_P
# set_property -dict { PACKAGE_PIN AA35 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA21_N }];      # FMC2_HPC_HA21_N
# set_property -dict { PACKAGE_PIN Y35  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA22_P }];      # FMC2_HPC_HA22_P
# set_property -dict { PACKAGE_PIN AA36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA22_N }];      # FMC2_HPC_HA22_N
# set_property -dict { PACKAGE_PIN Y37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_P }];      # FMC2_HPC_HA23_P
# set_property -dict { PACKAGE_PIN AA37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_N }];      # FMC2_HPC_HA23_N_HPC_HA14_P }];      # FMC2_HPC_HA14_P
# set_property -dict { PACKAGE_PIN AF36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA14_N }];      # FMC2_HPC_HA14_N
# set_property -dict { PACKAGE_PIN AE37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_P }];      # FMC2_HPC_HA15_P
# set_property -dict { PACKAGE_PIN AF37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA15_N }];      # FMC2_HPC_HA15_N
# set_property -dict { PACKAGE_PIN AG36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA16_P }];      # FMC2_HPC_HA16_P
...
# set_property -dict { PACKAGE_PIN AA36 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA22_N }];      # FMC2_HPC_HA22_N
# set_property -dict { PACKAGE_PIN Y37  IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_P }];      # FMC2_HPC_HA23_P
# set_property -dict { PACKAGE_PIN AA37 IOSTANDARD LVCMOS18 } [get_ports { FMC2_HPC_HA23_N }];      # FMC2_HPC_HA23_N

#cnn
# # Áp dụng Multicycle Path

# Thay vì dùng -from, ta gán Multicycle Path cho TẤT CẢ các đường dữ liệu
# đi đến các thanh ghi data này.
set_multicycle_path -setup -to [get_cells -hierarchical -filter {NAME =~ "*u_filter_buf/*fltbuf_dma_burst_o_reg*" && IS_SEQUENTIAL == 1}] 4
set_multicycle_path -hold -to [get_cells -hierarchical -filter {NAME =~ "*u_filter_buf/*fltbuf_dma_burst_o_reg*" && IS_SEQUENTIAL == 1}] 3
set _xlnx_shared_i0 [get_cells -hierarchical -filter {NAME =~ "*u_layer_info/*_q_reg*" && IS_SEQUENTIAL == 1}]
set_multicycle_path -setup -to $_xlnx_shared_i0 6
set_multicycle_path -hold -to $_xlnx_shared_i0 5



create_pblock pblock_cnn_accel
add_cells_to_pblock [get_pblocks pblock_cnn_accel] [get_cells -quiet [list cnn_accel]]
resize_pblock [get_pblocks pblock_cnn_accel] -add {SLICE_X14Y153:SLICE_X209Y299}
resize_pblock [get_pblocks pblock_cnn_accel] -add {DSP48_X0Y62:DSP48_X19Y119}
resize_pblock [get_pblocks pblock_cnn_accel] -add {RAMB18_X1Y62:RAMB18_X13Y119}
resize_pblock [get_pblocks pblock_cnn_accel] -add {RAMB36_X1Y31:RAMB36_X13Y59}

create_pblock pblock_hyperram0
add_cells_to_pblock [get_pblocks pblock_hyperram0] [get_cells -quiet [list hyperram0]]
resize_pblock [get_pblocks pblock_hyperram0] -add {SLICE_X98Y168:SLICE_X145Y221}
resize_pblock [get_pblocks pblock_hyperram0] -add {DSP48_X8Y68:DSP48_X12Y87}
resize_pblock [get_pblocks pblock_hyperram0] -add {RAMB18_X6Y68:RAMB18_X8Y87}
resize_pblock [get_pblocks pblock_hyperram0] -add {RAMB36_X6Y34:RAMB36_X8Y43}

# create_pblock pblock_video_streaming
# add_cells_to_pblock [get_pblocks pblock_video_streaming] [get_cells -quiet [list video_streaming]]
# resize_pblock [get_pblocks pblock_video_streaming] -add {SLICE_X46Y0:SLICE_X221Y207}
# resize_pblock [get_pblocks pblock_video_streaming] -add {DSP48_X3Y0:DSP48_X19Y81}
# resize_pblock [get_pblocks pblock_video_streaming] -add {RAMB18_X4Y0:RAMB18_X14Y81}
# resize_pblock [get_pblocks pblock_video_streaming] -add {RAMB36_X4Y0:RAMB36_X14Y40}

create_pblock pblock_hyperram1
add_cells_to_pblock [get_pblocks pblock_hyperram1] [get_cells -quiet [list hyperram1]]
resize_pblock [get_pblocks pblock_hyperram1] -add {SLICE_X56Y197:SLICE_X97Y260}
resize_pblock [get_pblocks pblock_hyperram1] -add {DSP48_X4Y80:DSP48_X6Y103}
resize_pblock [get_pblocks pblock_hyperram1] -add {RAMB18_X5Y80:RAMB18_X5Y103}
resize_pblock [get_pblocks pblock_hyperram1] -add {RAMB36_X5Y40:RAMB36_X5Y51}

create_pblock pblock_video_streaming
add_cells_to_pblock [get_pblocks pblock_video_streaming] [get_cells -quiet [list video_streaming]]
resize_pblock [get_pblocks pblock_video_streaming] -add {SLICE_X4Y9:SLICE_X217Y301}
resize_pblock [get_pblocks pblock_video_streaming] -add {DSP48_X0Y4:DSP48_X19Y119}
resize_pblock [get_pblocks pblock_video_streaming] -add {RAMB18_X0Y4:RAMB18_X14Y119}
resize_pblock [get_pblocks pblock_video_streaming] -add {RAMB36_X0Y2:RAMB36_X14Y59}
